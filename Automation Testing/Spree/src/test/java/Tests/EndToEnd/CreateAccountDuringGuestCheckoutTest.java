...
public class CreateAccountDuringGuestCheckoutTest extends TestBase {
    ...
    String email = "yousefhabashy2004@qa.team";
    ...
    public void checkoutAsGuest() {
        ...
        waitFor().until(ExpectedConditions.visibilityOf(checkoutPage.createAccountButton));
